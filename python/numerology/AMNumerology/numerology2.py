...
# Date: 09/24/2023
# Description: Taking the number 123456789, determines a permutation such that the left most digit is evenly divisible
# # by 1, the two left most digits are evenly divisible by 2, the three left most digits are divisible by 3, and so on.

# The smallest correct permutation is 381654729, and the elapsed time is 0.0009999275207519531 seconds.
...
print(f"The smallest correct permutation is {a}{b}{c}{d}{e}{f}{g}{h}{i}")
